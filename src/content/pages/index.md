...
Usamos fórmulas financeiras padrão. Porém, juros podem variar conforme a instituição financeira. Use como referência, não como recomendação final.
</details>

<details>
<summary>Vocês vendem meus dados?</summary>
Não. Não coletamos dados pessoais e não temos rastreadores. Leia nossa [Política de Privacidade](/privacidade).
</details>

<details>
<summary>Posso confiar nos resultados?</summary>
Sim. O código é aberto e os cálculos são transparentes. Sinta-se livre para verificar a matemática.
</details>
