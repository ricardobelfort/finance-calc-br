---
title: "CDI, SELIC, IPCA: O Que Significa?"
description: "As 3 taxas que definem toda rentabilidade do Brasil. Como funcionam e como afetam você."
---
...
1. BC define SELIC = 13%
2. Bancos usam isso como referência
3. CDB = ~13% (segue SELIC)
4. Tesouro = ~13% (prefixado) ou SELIC+0.5% (pós-fixado)
5. IPCA = 6% (inflação real)
6. Seu ganho real = 13% - 6% = 7%
...
**P: Qual taxa devo acompanhar?**

R: SELIC. As outras seguem dela.

**P: SELIC sobe = bom ou ruim?**

R: Depende da sua situação. Para aplicador é bom. Para empresário é ruim.

**P: Meu CDB deve vencer antes de SELIC mudar?**

R: Se é prefixado (ex: 13%), não importa. Você recebe 13% mesmo.

Se é pós-fixado (ex: 100% do CDI), seu ganho varia com CDI.

**P: Como SELIC afeta meu salário?**

R: Indiretamente. SELIC alta → menos empregos. SELIC baixa → mais empregos.

---

## Links Relacionados

- [Poupança vs CDB: Entenda as Taxas](/investimentos/poupanca-vs-cdb)
- [Tesouro Direto: Básico](/investimentos/tesouro-direto-basico)
- [Juros Compostos: Como Funciona](/investimentos/juros-compostos)

**Próximo passo:** Vê a SELIC atual (no site do BC). Depois vê seu CDB. Multiplica 100% ou 90% da SELIC. Pronto, agora entende quanto você ganha.
